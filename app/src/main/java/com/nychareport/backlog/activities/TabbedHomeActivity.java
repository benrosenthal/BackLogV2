...
import com.nychareport.backlog.fragments.FeedFragment;
import com.nychareport.backlog.fragments.PostProblemFragment;
...
public class TabbedHomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_user_preferences:
                Intent intent = new Intent(TabbedHomeActivity.this, UserOnboardingActivity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 1)
                return new PostProblemFragment();
            return new Fragment();
        }
